...
//static const uint8_t __flash DIGITS[NUM_OF_DIGITS]={0x7B, 0x0A, 0xB3, 0x9B, 0xCA, 0xD9, 0xF9, 0x0B, 0xFB, 0xDB, 0xEB, 0xFB, 0x71, 0x7B, 0xF1, 0xE1, 0x00}; // mapping for brake at pin 2
